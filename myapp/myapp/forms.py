...
class DestinationForm(forms.Form):
    ...
    checkin = forms.DateField(widget=forms.DateInput(attrs={'type': 'date', 'class': 'date-input', 'placeholder': 'Enter check-in date'}))
    checkout = forms.DateField(widget=forms.DateInput(attrs={'type': 'date', 'class': 'date-input', 'placeholder': 'Enter check-out date'}))
